...
console.log(
    dateTimezone.getDayOfWeek(),
    dateTimezone.getDay(),
    dateTimezone.getMonth(),
    dateTimezone.getYear(),
    dateTimezone.getHour(),
    dateTimezone.getMinute(),
    dateTimezone.getSeconds(),
    dateTimezone.getMilliseconds()
);
...
console.log(
    discordTimestamp.getDayOfWeek(),
    discordTimestamp.getDay(),
    discordTimestamp.getMonth(),
    discordTimestamp.getYear(),
    discordTimestamp.getHour(),
    discordTimestamp.getMinute(),
    discordTimestamp.getSeconds(),
    discordTimestamp.getMilliseconds()
);

console.log(
    discordTimestampTimezone.getDayOfWeek(),
    discordTimestampTimezone.getDay(),
    discordTimestampTimezone.getMonth(),
    discordTimestampTimezone.getYear(),
    discordTimestampTimezone.getHour(),
    discordTimestampTimezone.getMinute(),
    discordTimestampTimezone.getSeconds(),
    discordTimestampTimezone.getMilliseconds()
);
